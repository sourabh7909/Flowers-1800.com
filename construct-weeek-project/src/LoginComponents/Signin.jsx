import { Box,Center,Image,Spacer,Text,Flex,Grid, HStack, FormControl, FormLabel, Input, Button,Link } from '@chakra-ui/react'
...
const Signin = () => {
  ...
  return (
    ...
    // <Box pl={'42vh'} w={'100%'} h={'100vh'} backgroundImage={'http://thewowstyle.com/wp-content/uploads/2015/03/2-flower-wallpaper.jpg'}>
        ...
        <HStack pt={'25px'} gap={'0px'} templateColumns={'repeat(2,1fr)'}>
            ...
            <Box p={'30px'} borderRadius={'5px'} backgroundColor={'white'} width={'42%'} height={'535px'} boxShadow={' rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;'}>
                <Text color={"#4a4a4a"} fontWeight={'bold'} fontSize={'20px'}>Create Account</Text>
                <FormControl>
                    <Flex mt={'10px'} gap={0}>
                    <Box>
