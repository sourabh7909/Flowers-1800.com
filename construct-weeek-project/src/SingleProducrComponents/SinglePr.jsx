...
import { Box, Center, Flex, HStack, Image, Text,  Radio, RadioGroup ,Checkbox, Button} from '@chakra-ui/react'
      ...
      <Flex>
        ...
        <Box pl={'20px'} w={'48%'} >
          <Box>
            ...
            <Button _hover={'none'} cursor={'pointer'} borderRadius={'4px'} h={'50px'} w={'95%'} fontSize={'16px'} color={'white'} backgroundColor={'#61C278'}>Add to Cart</Button>
          </Box>
        </Box>
      </Flex>
    </Box>
